...
contract DeployPool is Script {
    ...
    IPositionManager constant POSITION_MANAGER =
        IPositionManager(payable(0x429ba70129df741B2Ca2a85BC3A2a3328e5c09b4));
    ...
    uint160 constant INITIAL_SQRT_PRICE_X96 =
    ...
    function _deployHook(
        Registry registry
    ) internal returns (ProofPoolHook hook) {
        ...
        hook = new ProofPoolHook{salt: salt}(POOL_MANAGER, registry);
    ...
    function _addLiquidity(PoolKey memory key) internal {
        ...
        (uint256 amount0Desired, uint256 amount1Desired) = Currency.unwrap(
            key.currency0
        ) == WETH
